...
public class ConfigProperty
{
    ...
    public ConfigProperty(String name, String value, Type type)
    {
        this(name, value, type, false, new String[0], new String[0], name);
    }

    public ConfigProperty(String name, String value, Type type, boolean read)
    {
        this(name, value, type, read, new String[0], new String[0], name);
    }

    public ConfigProperty(String name, String value, Type type, String[] validValues)
    {
        this(name, value, type, false, validValues, new String[0], name);
    }

    public ConfigProperty(String name, String value, Type type, String[] validValues, String[] validValuesDisplay)
    {
        this(name, value, type, false, validValues, validValuesDisplay, name);
    }

    public ConfigProperty(String name, String value, Type type, String langKey)
    {
        this(name, value, type, false, new String[0], new String[0], langKey);
    }

    public ConfigProperty(String name, String value, Type type, boolean read, String langKey)
    {
        this(name, value, type, read, new String[0], new String[0], langKey);
    }

    public ConfigProperty(String name, String value, Type type, String[] validValues, String langKey)
    {
        this(name, value, type, false, validValues, new String[0], langKey);
    }

    public ConfigProperty(String name, String value, Type type, String[] validValues, String[] validValuesDisplay, String langKey)
    {
        this(name, value, type, false, validValues, validValuesDisplay, langKey);
    }

    ConfigProperty(String name, String value, Type type, boolean read, String[] validValues, String[] validValuesDisplay, String langKey)
    {
        setName(name);
        this.value = value;
    ...
    public ConfigProperty(String name, String[] values, Type type)
    {
        this(name, values, type, false);
    }

    ConfigProperty(String name, String[] values, Type type, boolean read)
    {
        this(name, values, type, read, new String[0], name);
    }

    public ConfigProperty(String name, String[] values, Type type, String langKey)
    {
        this(name, values, type, false, langKey);
    }

    ConfigProperty(String name, String[] values, Type type, boolean read, String langKey)
    {
        this(name, values, type, read, new String[0], langKey);
    }

    ConfigProperty(String name, String[] values, Type type, boolean read, String[] validValues, String langKey)
    {
        this(name, values, type, read, validValues, new String[0], langKey);
    }

    ConfigProperty(String name, String[] values, Type type, boolean read, String[] validValues, String[] validValuesDisplay, String langKey)
    {
        setName(name);
        this.type   = type;
     ...
     */
    public ConfigProperty setToDefault()
    {
     ...
     */
    public ConfigProperty setRequiresWorldRestart(boolean requiresWorldRestart)
    {
     ...
     * Defaults to true.
     */
    public ConfigProperty setShowInGui(boolean showInGui)
    {
     ...
     * this property while a world is running.
     */
    public ConfigProperty setRequiresMcRestart(boolean requiresMcRestart)
    {
     ...
     */
    public ConfigProperty setMaxListLength(int max)
    {
     ...
     */
    public ConfigProperty setIsListLengthFixed(boolean isListLengthFixed)
    {
     ...
     */
    public ConfigProperty setValidationPattern(Pattern validationPattern)
    {
     ...
     */
    public ConfigProperty setLanguageKey(String langKey)
    {
        this.langKey = langKey;
        return this;
    }
     ...
     */
    public ConfigProperty setDefaultValue(String defaultValue)
    {
     ...
     */
    public ConfigProperty setDefaultValues(String[] defaultValues)
    {
        this.defaultValue = "";
     ...
     */
    public ConfigProperty setDefaultValue(int defaultValue)
    {
     ...
     */
    public ConfigProperty setDefaultValues(int[] defaultValues)
    {
     ...
     */
    public ConfigProperty setDefaultValue(double defaultValue)
    {
     ...
     */
    public ConfigProperty setDefaultValues(double[] defaultValues)
    {
        String[] temp = new String[defaultValues.length];
        for (int i = 0; i < defaultValues.length; i++)
     ...
     */
    public ConfigProperty setDefaultValue(boolean defaultValue)
    {
     ...
     */
    public ConfigProperty setDefaultValues(boolean[] defaultValues)
    {
        String[] temp = new String[defaultValues.length];
        for (int i = 0; i < defaultValues.length; i++)
     ...
     */
    public ConfigProperty setMinValue(int minValue)
    {
     ...
     */
    public ConfigProperty setMaxValue(int maxValue)
    {
     ...
     */
    public ConfigProperty setMinValue(double minValue)
    {
     ...
     */
    public ConfigProperty setMaxValue(double maxValue)
    {
     ...
     */
    public ConfigProperty setValidValues(String[] validValues)
    {
        this.validValues = validValues;
        return this;
    }
    ...
    public ConfigProperty setValidValuesDisplay(String[] validValuesDisplay)
    {
     ...
     */
    public ConfigProperty setValues(String[] values)
    {
        this.values = Arrays.copyOf(values, values.length);
        changed = true;
        return this;
     ...
     */
    public ConfigProperty setValue(int value)
    {
     ...
     */
    public ConfigProperty setValue(boolean value)
    {
     ...
     */
    public ConfigProperty setValue(double value)
    {
     ...
     */
    public ConfigProperty setValues(boolean[] values)
    {
     ...
     */
    public ConfigProperty setValues(int[] values)
    {
        this.values = new String[values.length];
        for (int i = 0; i < values.length; i++)
            this.values[i] = String.valueOf(values[i]);
     ...
     */
    public ConfigProperty setValues(double[] values)
    {
        this.values = new String[values.length];
        for (int i = 0; i < values.length; i++)
            this.values[i] = String.valueOf(values[i]);
